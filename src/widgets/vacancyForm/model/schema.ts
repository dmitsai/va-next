...
const baseSchema = z.object({
  ...
  description: z.string().min(1,CONSTANTS.errors.validation.vacancy.description.required).min(50, CONSTANTS.errors.validation.vacancy.description.min),
  salaryFrom: z
          .union([
              z.literal(''),
...
const dynamicFilterFields = tags.reduce((acc, tagGroup) => {
