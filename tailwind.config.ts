  ...
  theme: {
  	...
  	extend: {
  		...
  		colors: {
  			...
  			amber: 'rgb(var(--peach) / <alpha-value>)',
  			...
  			/* catppuccin raw aliases used in admin tables */
  			subtext1: 'rgb(var(--sub) / <alpha-value>)',
  			subtext0: 'rgb(var(--sub-secondary) / <alpha-value>)',
  			overlay2: 'rgb(var(--overlay) / <alpha-value>)',
  			overlay1: 'rgb(var(--overlay-secondary) / <alpha-value>)',
  			overlay0: 'rgb(var(--overlay-tertiary) / <alpha-value>)',
  			surface2: 'rgb(var(--surface) / <alpha-value>)',
  			surface1: 'rgb(var(--surface-secondary) / <alpha-value>)',
  			surface0: 'rgb(var(--surface-tertiary) / <alpha-value>)',
